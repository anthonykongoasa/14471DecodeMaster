...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -3033.223574557996; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1418.7873103339919; // x position of the perpendicular encoder (in tick units)
    }
